...
| Item | Owner | Notes |
|------|-------|-------|
| **Widget rebuild (Tier 0+1+2)** | i-dream | **The owner's biggest pain** — audited 2026-05-25, plan in [`docs/22`](./22-widget-audit.md). Wire reflect/review + non-blocking DataStore + cut ~1500 lines. Rewire+subtract, not rewrite. Not started. |
